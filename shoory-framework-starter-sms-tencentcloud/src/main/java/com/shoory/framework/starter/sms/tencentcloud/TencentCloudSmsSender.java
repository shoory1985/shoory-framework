...
public class TencentCloudSmsSender implements SmsComponent {
	 ...
	 * @throws Exception
	 */
	public void sendVoice(String nationCode, String phoneNumber, String msg, int playtimes) throws Exception {
	...
	private HttpURLConnection getPostHttpConn(String url) throws Exception {
	...
	private String calculateSigForTempl(String appkey, long random, long curTime, ArrayList<String> phoneNumbers)
